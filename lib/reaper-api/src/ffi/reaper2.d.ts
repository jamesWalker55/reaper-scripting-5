...
declare namespace reaper {
  ...
  /**
   * ```
   * identifier _ = reaper.JS_Window_Find(string title, boolean exact)
   * ```
   ...
   */
  function JS_Window_Find(title: string, exact: boolean): identifier;
  ...
  /**
   * ```
   * identifier _ = reaper.JS_Window_FindChildByID(identifier parentHWND, integer ID)
   * ```
   ...
   */
  function defer(fun: Function): void;
   ...
   */
  function get_action_context(): void;
